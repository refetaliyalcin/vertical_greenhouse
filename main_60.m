...
fileID = fopen('Case_1_60.idf','w');
fprintf(fileID,'%s',text1);
fclose(fileID);
fileID = fopen('Case_2_60.idf','w');
fprintf(fileID,'%s',text2);
fclose(fileID);
fileID = fopen('Case_3_60.idf','w');
fprintf(fileID,'%s',text3);
fclose(fileID);
fileID = fopen('Case_4_60.idf','w');
fprintf(fileID,'%s',text4);
fclose(fileID);
fileID = fopen('Case_5_60.idf','w');
...
yticks([1 60 120 180 240 300 365])
set(gca,'FontSize',13)
saveas(gcf,'60_fig_6a.png')

% error('stop')


ep_result_1 = call_ep('Case_1_60','NOR_Oslo.Fornebu.014880_IWEC');
ep_result_2 = call_ep('Case_2_60','NOR_Oslo.Fornebu.014880_IWEC');
ep_result_3 = call_ep('Case_3_60','NOR_Oslo.Fornebu.014880_IWEC');
ep_result_4 = call_ep('Case_4_60','NOR_Oslo.Fornebu.014880_IWEC');
ep_result_5 = call_ep('Case_5_60','NOR_Oslo.Fornebu.014880_IWEC');
