...
fileID = fopen('Case_1_41.idf','w');
fprintf(fileID,'%s',text1);
fclose(fileID);
fileID = fopen('Case_2_41.idf','w');
fprintf(fileID,'%s',text2);
fclose(fileID);
fileID = fopen('Case_3_41.idf','w');
fprintf(fileID,'%s',text3);
fclose(fileID);
fileID = fopen('Case_4_41.idf','w');
fprintf(fileID,'%s',text4);
fclose(fileID);
fileID = fopen('Case_5_41.idf','w');
...
yticks([1 60 120 180 240 300 365])
set(gca,'FontSize',13)
saveas(gcf,'41_fig_6a.png')


ep_result_1 = call_ep('Case_1_41','TUR_Istanbul.170600_IWEC');
ep_result_2 = call_ep('Case_2_41','TUR_Istanbul.170600_IWEC');
ep_result_3 = call_ep('Case_3_41','TUR_Istanbul.170600_IWEC');
ep_result_4 = call_ep('Case_4_41','TUR_Istanbul.170600_IWEC');
ep_result_5 = call_ep('Case_5_41','TUR_Istanbul.170600_IWEC');
